...
dap_map('<leader>du', require('dapui').toggle, 'toggle dap-[u]i')
dap_map('<F4>', require('dapui').toggle, 'toggle dap-[u]i')
dap_map('<leader>db', require('dap').toggle_breakpoint, 'toggle [b]reakpiont')
dap_map('<F9>', require('dap').toggle_breakpoint, 'toggle [b]reakpiont')
dap_map('<leader>dc', require('dap').continue, '[c]ontinue')
dap_map('<F5>', require('dap').continue, '[c]ontinue')
dap_map('<leader>dt', require('dap').terminate, '[t]erminate')
dap_map('<S-F5>', require('dap').terminate, '[t]erminate')
dap_map('<leader>dr', require('dap').restart, '[r]estart')
dap_map('<C-S-F5>', require('dap').restart, '[r]estart')
dap_map('<leader>dp', require('dap').pause, '[p]ause')
dap_map('<F6>', require('dap').pause, '[p]ause')
dap_map('<leader>dn', require('dap').step_over, '[n]ext/step over')
dap_map('<F10>', require('dap').step_over, '[n]ext/step over')
dap_map('<leader>ds', require('dap').step_into, '[s]tep into')
dap_map('<F11>', require('dap').step_into, '[s]tep into')
dap_map('<leader>df', require('dap').step_out, '[f]inish/step out')
dap_map('<S-F11>', require('dap').step_out, '[f]inish/step out')
